    ...
    try {
      ...
      const usuarios = [
        ...
        },
        {
          ...
          email: 'maria@aula.com',
          contraseña: hashedPassword,
          rol: 'profesor',
        },
        {
          nombre: 'Prof. Carlos Ruiz',
          email: 'carlos@aula.com',
          contraseña: hashedPassword,
          rol: 'profesor',
        },
        {
        ...
        {
          nombre: 'Sofia Torres',
          email: 'sofia@aula.com',
          contraseña: hashedPassword,
          rol: 'estudiante',
        },
        {
          nombre: 'Diego Ramírez',
          email: 'diego@aula.com',
          contraseña: hashedPassword,
          rol: 'estudiante',
        },
      ];
      ...
      for (let cursoId = 1; cursoId <= 10; cursoId++) {
        for (let estudianteId = 5; estudianteId <= 8; estudianteId++) {
      ...
      const tareasData = [
        {
          ...
          descripcion: 'Resolver los ejercicios del capítulo 5',
          cursoId: 1,
          fechaEntrega: '2025-01-20',
          puntajeMaximo: 20,
        },
        {
          titulo: 'Proyecto React - Todo App',
          descripcion: 'Crear una aplicación de tareas con React Hooks',
          cursoId: 2,
        ...
        },
        {
          ...
          descripcion: 'Implementar algoritmo de regresión desde cero',
          cursoId: 3,
          fechaEntrega: '2025-01-23',
          puntajeMaximo: 20,
        },
        {
          titulo: 'Diseño de Base de Datos',
          descripcion: 'Modelar una base de datos para e-commerce',
          cursoId: 4,
      ...
      const recursosData = [
        {
          nombre_archivo: 'Libro: Cálculo de Stewart',
          tipo_recurso: 'pdf',
          url: 'https://example.com/calculo.pdf',
          cursoId: 1,
        },
        {
          nombre_archivo: 'Guía de React Hooks',
          tipo_recurso: 'pdf',
          url: 'https://example.com/react-hooks.pdf',
          cursoId: 2,
        },
        {
          nombre_archivo: 'Dataset: Iris Flowers',
          tipo_recurso: 'archivo',
          url: 'https://example.com/iris.csv',
          cursoId: 3,
        },
        {
          nombre_archivo: 'Cheat Sheet: SQL Commands',
          tipo_recurso: 'pdf',
      ...
      for (const recursoData of recursosData) {
        const exists = await this.resourcesRepository.findOne({
          where: {
            nombre_archivo: recursoData.nombre_archivo,
            cursoId: recursoData.cursoId,
          },
        });
        if (!exists) {
      ...
      const forosData = [
        {
          titulo: 'Dudas sobre Derivadas',
          descripcion: 'Espacio para consultas del tema',
          cursoId: 1,
          creadorId: 2,
        },
        {
          titulo: 'Proyecto Final - Consultas',
          descripcion: 'Preguntas sobre el proyecto',
          cursoId: 2,
          creadorId: 2,
        },
      ];
