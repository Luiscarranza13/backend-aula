// Script para poblar la base de datos de Railway con datos de prueba
const mysql = require('mysql2/promise');
const bcrypt = require('bcrypt');

async function seedRailway() {
  // Credenciales de Railway - usando host público
  ...
  try {
    ...
    for (const curso of cursos) {
      try {
        ...
        if (e.code !== 'ER_DUP_ENTRY') throw e;
        console.log(`  ⚠️  Curso ${curso.nombre} ya existe, saltando...`);
      }
    }
    console.log(`✅ Cursos procesados\n`);
    ...
    console.log(`✅ Recursos procesados\n`);
    ...
    console.log(`✅ Mensajes procesados\n`);

    console.log('✨ Seed en Railway completado exitosamente!\n');
    console.log('📊 Resumen:');
